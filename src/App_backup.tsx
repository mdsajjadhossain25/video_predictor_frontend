              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-xl">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-green-600">{stats.completedPredictions}</p>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-8">
              ...
              {isEditing && (
                <div className="flex gap-4 mt-8">
                  ...
                  <button
                    onClick={handleCancel}
                    className="px-8 py-3 bg-gray-100 text-gray-700 rounded-xl font-medium hover:bg-gray-200 transition-colors flex items-center gap-2"
                  >
                    <X className="w-5 h-5" />
                    Cancel
                  </button>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Receive updates about your predictions</p>
                  </div>
